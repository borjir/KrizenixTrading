...
def create_list_customize(self):
    ...
    self.average_data_list_table.horizontalHeader().setSectionResizeMode(2, QHeaderView.ResizeToContents)
    self.average_data_list_table.horizontalHeader().setSectionResizeMode(5, QHeaderView.ResizeToContents)
